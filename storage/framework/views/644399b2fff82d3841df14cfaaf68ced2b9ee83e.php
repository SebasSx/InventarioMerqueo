                ...
                <div class="col-md-10 col-md-offset-1">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="form" role="form" autocomplete="off" action="<?php echo e(route('store')); ?>" method="post">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-9">
                                        ...
                                        <a href="<?php echo e(route('products')); ?>"><span class="btn btn-danger">Cancelar</span> </a>
